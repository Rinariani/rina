...
$('#categories').select2({
  ajax: {
    url: 'http://localhost/larashop_amilia/public/ajax/categories/search',
...
<?php endif; ?>
      ...
      <form 
        ...
        <select name="categories[]" multiple id="categories" class="form-control"></select><br>
        <br/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\larashop_amilia\resources\views/books/create.blade.php ENDPATH**/ ?>